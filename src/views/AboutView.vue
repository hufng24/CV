    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 6,
          name: 'Java',
          imageUrl: 'https://img.icons8.com/color/480/java-coffee-cup-logo--v1.png',
          status: 'Advance'
        },
        {
          id: 7,
    ...
    <article data-page="about">
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-96 rounded-full mb-3 fadein-up"
            src="../../dist/img/z6007973556104_b6928aec9c50ae726ded2c9373aaae3a.jpg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Hung Nguyen. I'm a web developer from Vinh Phuc. I
