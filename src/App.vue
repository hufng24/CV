    ...
    <nav class="max-w-7xl px-5 md:fixed top-0 z-[98] w-screen backdrop-blur-md bg-[#121212] bg-opacity-80">
      <div class="container mx-auto flex flex-wrap items-center justify-between">
        <button @click="redirectToHome" class="flex">
          <span class="self-center text-lg text-[#ffdb70] font-semibold whitespace-nowrap fadein-bot hover:text-amber-100">Hùng Nguyễn</span>
        </button>
        <div class="flex md:order-2 fadein-bot">
          <a href="https://www.facebook.com/hufng24/"><img class="w-9 rounded-full" src="../dist/img/z6007973556104_b6928aec9c50ae726ded2c9373aaae3a.jpg" alt="github"></a>
        </div>
